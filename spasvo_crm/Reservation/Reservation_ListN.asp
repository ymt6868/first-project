...
<table width="100%" height="20" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#006699">
  <tr>
    <td bgcolor="#006699"><table width="80%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><font color="#FFFFFF">----等待预订----</font></td>
      </tr>
    </table></td>
  </tr>
</table>
...
%>   
  <tr align="center" bgcolor="<%=Mybgcolor%>">
    ...
    <td height="28" align="center"><a href="Reservation_Edit.asp?Id=<%=trim(rs("Reservation_ID"))%>">编辑</a></td>
    <td align="center"><a href="Reservation_View.asp?Id=<%=trim(rs("Reservation_Id"))%>">查看</a></td>
  </tr>
<%
	rs.movenext
	next
